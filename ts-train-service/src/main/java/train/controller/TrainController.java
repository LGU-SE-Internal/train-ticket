...
public class TrainController {
    ...
    @Operation(summary = "Get train types by names", description = "Retrieve multiple train types by their names")
    @CrossOrigin(origins = "*")
    ...
    @Operation(summary = "Get all train types", description = "Retrieve all train types in the system")
    @CrossOrigin(origins = "*")
